...
path <- "/Users/hugoho/OneDrive/Yale/2021 Fall/BIS 620 Data Science Software Systems/Assignments/Assignment 1/NCT00460265"
...
```{r}
ae_list <-  as.data.frame(table(data_list$ae$AETERM))
...
ae_top5_df <- data_list$ae %>% filter(AETERM%in% ae_top5)
